...
export default function Card({ cardData }) {
  return (
    <div className="group flex relative rounded flex-col items-center max-w-md min-h-96  m-8 h-[360px] xl:h-[400px] overflow-hidden">
      ...
      <span className="flex flex-col items-center h-1/2 mt-4 gap-2 overflow-hidden">
        <span className="h-3/4 flex flex-col items-center text-center">
          ...
          <p className="line-clamp-3 pb-0">{cardData.text}</p>
        </span>
